                  ...
                  @include('partials.error')
                    ...
                    <div class="col-lg-12">
                        <div class="quotes" >
                                ...
                                <div class="title-2" class="card-header" style="margin-top:-2px; margin-left: -15px; background-color: #31baf0ee; height: 56px;
                                font-color:black">
                                        <center><h1 class="title-single"  style="color:black">Inscrivez vous a la ceremonie de consecration</h1></center>
                            </div>

                            <form  class="card-header" style="margin-top:5%; background-color: white; margin-left: -15px " method="post" action="{{route('inscriptionConsecration')}}" >
                              @csrf
                                    <div class="form-row">
