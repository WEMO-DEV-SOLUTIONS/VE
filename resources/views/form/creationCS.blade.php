                ...
                <div class="blog_right_sidebar">
                   ...
                   <br>
                    <aside class="single_sidebar_widget popular_post_widget">
                        ...
                        <div class="title-2"  class=" form-card" style="margin-top:-2px; margin-left: -1px; background-color: #31baf0ee; height: 56px">
                            <center><h2 class="title-single" style="color:black">Creation d'un comite de soutien</h2></center>
                      </div>
