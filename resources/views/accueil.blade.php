  ...
  <section class="property-single nav-arrow-b">
    <div class="container">
      <div class="row">
        ...
        <div class="bg-video">
          <video src="video/bg" height="450" width="1300"  style="margin-left: -80px"  controls autoplay></video>
        </div>
        ...
        <div class="row" style="margin-top: 50px">
          ...
          <div class="col-lg-6 pull-right">
            ...
            <div class="card-img">
                <br>
                <br>
                <img src="img/compo de visuels.jpg" alt="" height="400" width="1100">
              </div>
  ...
  <section class="section-agents section-t8">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div>
              <center><span class="fa fa-users fa-4x"  style="color:skyblue"></span></center>
