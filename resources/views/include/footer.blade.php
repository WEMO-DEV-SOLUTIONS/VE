          ...
          <div class="widget-a">
            ...
            <div class="w-footer-a">
              <ul class="list-unstyled">
                <li class="color-a">
                  <span class="color-text-a">Telephone .</span> (+237) 663 159 911</li>
                <li class="color-a">
                    <span class="color-text-a"></span> BP 12226 Yaoundé Cameroun</li>
                  <span class="color-text-a">Email .</span> valeurseternelles@gmailcom</li>
                  <li class="color-a">
              </ul>
            </div>
          </div>
              ...
              <ul class="list-unstyled">
                  <form class="form-a contactForm" action="" method="post" role="form">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <button type="submit" class="btn btn-a">S'inscrire</button>
                        </div>
                      </div>
                    </form>
              </ul>
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">Nations pour l'Eternelle</span> Tous droits resrvé.
            </p>
          </div>
          <div class="credits">
