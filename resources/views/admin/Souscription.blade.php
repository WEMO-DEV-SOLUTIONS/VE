				...
				<div class="col-xl-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-body">
							<table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle">
								...
								<thead>
									<tr>
                                        ...
                                        <th class="text-nowrap">DATE DE SOUSCRIPTION</th>
							...
							@foreach ($souscription as $key => $souscription)
									...
									<tr class="gradeA">
										...
										<td>{{ number_format($souscription->montant)}} FCFA</td>
										<td>{{$souscription->created_at}}</td>
